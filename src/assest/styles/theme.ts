...
export const myThemes: IState = {
   sunny: {
      wrapperBackground: `
         url('./images/sunny_blur.jpg') 0 0/100% 100% no-repeat,
      ...
      containerBackground: `
         ...
         url('./images/cloudy.jpg') 0 0/cover no-repeat,
         url('./images/rainy.jpg') 0 0/cover no-repeat,
         url('./images/snowy.jpg') 0 0/cover no-repeat,
         url('./images/overcast.jpg') 0 0/cover no-repeat
      `,
   },
   cloudy: {
      wrapperBackground: `
